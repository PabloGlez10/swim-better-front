<template>
  <footer class="swim-better-footer swim-better-section img">
    <div class="overlay"></div>
    <div class="container">
      <div class="columns mb-5">
        <div class="column is-3 mb-5 mb-md-5">
          <div class="swim-better-footer-widget mb-4">
            <h2 class="swim-better-heading-2">About Me</h2>
            <p>
            ...
            <ul class="swim-better-social list-unstyled float-md-left float-lft mt-5">
              <li class="">
        ...
        <div class="column is-2 mb-5 mb-md-5">
          <div class="swim-better-footer-widget mb-4 ml-md-4">
            ...
            <ul class="list-unstyled">
              <li><a href="#" class="py-2 is-block">Home</a></li>
              <li><a href="#" class="py-2 is-block">Ejercicios</a></li>
              <li><a href="#" class="py-2 is-block">Randomizador</a></li>
              <li><a href="#" class="py-2 is-block">Calendario</a></li>
            </ul>
          </div>
        </div>
        <div class="columns">
